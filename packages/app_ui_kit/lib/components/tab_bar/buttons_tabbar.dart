...
class ButtonsTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize {
    return Size.fromHeight(height ?? (_kTabHeight + contentPadding.vertical + buttonMargin.vertical));
  }
...
class _ButtonsTabBarState extends State<ButtonsTabBar> with TickerProviderStateMixin {
  ...
  Widget _buildButton(
    ...
    final TextStyle? textStyle = TextStyle.lerp(widget.unselectedLabelStyle ?? const TextStyle(color: Colors.black), widget.labelStyle ?? const TextStyle(color: Colors.white), animationValue);
      ...
      child: TextButton(
        ...
        child: Ink(
          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                tab.icon != null ? IconTheme.merge(data: IconThemeData(size: 24.0, color: foregroundColor), child: tab.icon!) : Container(),
                SizedBox(
        ...
        builder: (context, child) => SizedBox(
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              ...
              children: [
                if (widget.paddingX != null)
                  SizedBox(
                    width: widget.paddingX,
                  ),
                ...List.generate(
                  widget.tabs.length,
  ...
  _scrollTo(int index) {
    ...
    _scrollController.animateTo(offset + _scrollController.offset, duration: Duration(milliseconds: widget.duration), curve: Curves.easeInOut);
  }
}
