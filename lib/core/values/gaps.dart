...
class Gaps {
  ...
  static Widget get dividerGray12 => Container(
        height: 12,
        color: AppThemeExtension.light.grayBackground,
      );

  static Widget get dividerGray16 => Container(
        height: 16,
        color: AppThemeExtension.light.grayBackground,
      );

  static Widget dividerGray24(BuildContext context) => Container(
        height: 24,
  ...
  static final Widget dividerGraySpace = Divider(
    thickness: 1,
    color: AppThemeExtension.light.grayBackground,
  );
